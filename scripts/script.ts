...
class Cat extends Animal {
    ...
    pattern: string;
    address: string;
    constructor(name: string, age: number, gender: string, size: string, vaccine: string, img: string, breed: string, pattern: string, address: string) {
...
class Dog extends Animal {
    ...
    constructor(name: string, age: number, gender: string, size: string, vaccine: string, img: string, breed: string, trainingskill: string) {
        super(name, age, gender, size, vaccine, img);
        this.breed = breed;
...
let animals: Array<Animal> = [animal1, animal2, cat1, cat2, dog1, dog2, dog3, dog4];
